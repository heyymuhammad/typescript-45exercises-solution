...
let message = "Words, without power, is mere philosophy."
...
let vehicles = ["Supra", "Audi", "BMW", "Mc Laren"]
console.log(`I would like to gift a ${vehicles[0]} Car to my brother.`)
console.log(`I would like to drive a ${vehicles[1]} Car.`)
console.log(`I would like to own a ${vehicles[2]} Car.`)
console.log(`I would like to buy a ${vehicles[3]} Car.`)
...
guests = ["Ami", "Abu"]
console.log(`I am inviting ${guests.length} persons`)
...
let menu= ["Pizza", "Burger", "Roll", "Pasta", "Wings", "Fish"]
...
let index_error_array: string[] = ["Boston", "Harvard", "MIT"]
...
if (alien_color == "green") {
    ...
    console.log(`You earned 10 points for shooting the ${alien_color} alien.`);
}
...
if (alien_color == "green") {
    console.log(`You earned 5 points for shooting the ${alien_color} alien.`);
}
else if (alien_color == "yellow") {
    console.log(`You earned 10 points for shooting the ${alien_color} alien.`);
}
else if (alien_color == "red") {
    console.log(`You earned 15 points for shooting the ${alien_color} alien.`);
}
...
let current_users : string[] = ["steve", "peter", "watson", "jessica", "helena", "katty"]
let new_users : string[] = ["Ronaldo", "WATSON", "Kim", "Peter"]
...
let favorite_pizzas : string[] = ["Fagita", "BBQ", "Pepperoni"] 

for (let index = 0; index < favorite_pizzas.length; index++) {
    console.log(`I like ${favorite_pizzas[index]} Pizza.`)
}
...
let animals : string[] = ["Horse", "Cheetah", "Rabbit"] 
for (let index = 0; index < animals.length; index++) {
    console.log(`A ${animals[index]} can run faster than human.`)
}
...
function make_shirt(size: string, message: string) {
    console.log(`${size} size t-shirt should be printed with message "${message}" on it.`)
}
...
function make_album(artist_name: string, album_title: string, tracks?: number) {
    let album = {album_title, artist_name, tracks}
    if (tracks == undefined) {
        delete album.tracks
    }
    return album;
